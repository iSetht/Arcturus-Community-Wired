...
public class WiredTriggerAvatarWalkOnFurni extends InteractionWiredTrigger {
    ...
    public WiredTriggerAvatarWalkOnFurni(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
        this.items = new THashSet<>();
    }

    public WiredTriggerAvatarWalkOnFurni(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
