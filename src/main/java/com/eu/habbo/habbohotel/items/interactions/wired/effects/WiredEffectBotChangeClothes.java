...
public class WiredEffectBotChangeClothes extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.BOT_CHANGE_CLOTHES;

    private String botName = "";
    private String botLook = "";

    public WiredEffectBotChangeClothes(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredEffectBotChangeClothes(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
