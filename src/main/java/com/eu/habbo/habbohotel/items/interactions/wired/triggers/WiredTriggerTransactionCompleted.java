...
public class WiredTriggerTransactionCompleted extends InteractionWiredTrigger {
    public static final WiredTriggerType type = WiredTriggerType.TRANSACTION_COMPLETED;
    ...
    public WiredTriggerTransactionCompleted(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
        super(id, userId, item, extradata, limitedStack, limitedSells);
    }

    @Override
    public boolean matches(HabboItem triggerItem, WiredEvent event) {
        if (event == null || event.getType() != WiredEvent.Type.TRANSACTION_COMPLETED) {
            return false;
        }
