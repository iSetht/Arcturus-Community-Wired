...
public class WiredEffectExecuteStacks extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.EXECUTE_STACKS;

    private THashSet<HabboItem> items;

    public WiredEffectExecuteStacks(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
        this.items = new THashSet<>();
    }

    public WiredEffectExecuteStacks(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
