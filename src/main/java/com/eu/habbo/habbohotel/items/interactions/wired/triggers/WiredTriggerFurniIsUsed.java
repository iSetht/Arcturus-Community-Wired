...
public class WiredTriggerFurniIsUsed extends InteractionWiredTrigger {
    private static final WiredTriggerType type = WiredTriggerType.FURNI_USED;

    private THashSet<HabboItem> items;
    private int furniSource = WiredSources.SOURCE_SELECTED;

    public WiredTriggerFurniIsUsed(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
        this.items = new THashSet<>();
    }

    public WiredTriggerFurniIsUsed(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
