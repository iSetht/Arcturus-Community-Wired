...
public class WiredTriggerAvatarWalkOffFurni extends InteractionWiredTrigger {
    ...
    public WiredTriggerAvatarWalkOffFurni(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
        this.items = new THashSet<>();
    }

    public WiredTriggerAvatarWalkOffFurni(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
    ...
    public boolean matches(HabboItem triggerItem, WiredEvent event) {
        ...
        return WiredTriggerSources.isTopItemMatched(
            room,
