...
public class WiredEffectExecuteStacksNegative extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.NEGATIVE_EXECUTE_STACKS;
    ...
    public WiredEffectExecuteStacksNegative(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
    ...
    public void execute(WiredContext ctx) {
        ...
        // Execute negative effects at tiles with incremented call stack depth.
        WiredManager.executeEffectsAtTiles(usedTiles, ctx, currentDepth + 1);
    }
