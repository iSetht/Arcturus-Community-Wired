...
public class InteractionWiredDisable extends HabboItem {
    public InteractionWiredDisable(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public InteractionWiredDisable(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
