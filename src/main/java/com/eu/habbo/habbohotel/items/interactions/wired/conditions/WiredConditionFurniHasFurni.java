...
public class WiredConditionFurniHasFurni extends InteractionWiredCondition {
    public static final WiredConditionType type = WiredConditionType.HAS_FURNI_ON;

    private boolean all;
    private int furniSource = WiredSources.SOURCE_SELECTED;
    private THashSet<HabboItem> items;

    public WiredConditionFurniHasFurni(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
        this.items = new THashSet<>();
    }

    public WiredConditionFurniHasFurni(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
