...
public class WiredTriggerAvatarClicksFurni extends InteractionWiredTrigger {
    public static final WiredTriggerType type = WiredTriggerType.CLICK_FURNI;

    private THashSet<HabboItem> items;
    private int furniSource = WiredSources.SOURCE_SELECTED;

    public WiredTriggerAvatarClicksFurni(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
        this.items = new THashSet<>();
    }

    public WiredTriggerAvatarClicksFurni(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
    ...
    public boolean matches(HabboItem triggerItem, WiredEvent event) {
        ...
        List<HabboItem> resolvedItems = WiredTriggerSources.fetchSourceItems(
            this, event, this.furniSource, this.items
        );

        return resolvedItems.contains(sourceItem);
    }
