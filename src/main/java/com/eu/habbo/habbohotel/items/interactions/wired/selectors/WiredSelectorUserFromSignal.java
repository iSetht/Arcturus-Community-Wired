...
public class WiredSelectorUserFromSignal extends InteractionWiredSelector {

    public static final WiredSelectorType type = WiredSelectorType.USER_FROM_SIGNAL;

    public WiredSelectorUserFromSignal(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredSelectorUserFromSignal(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
    ...
    /**
     * Returns the users carried by the incoming signal.
    ...
    /** No furni storage — this selector is user-only. */
    @Override
