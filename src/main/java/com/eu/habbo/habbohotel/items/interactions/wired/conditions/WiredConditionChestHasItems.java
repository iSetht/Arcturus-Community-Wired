...
public class WiredConditionChestHasItems extends InteractionWiredCondition {
    ...
    public boolean evaluate(WiredContext ctx) {
        ...
        List<HabboItem> resolvedChests = ChestWiredUtil.onlyChests(chestManager, ChestWiredUtil.resolveItems(this, ctx, this.chestSource, this.selectedItems, this.secondarySelectedItems), true, true);
        ...
        for (HabboItem chest : resolvedChests) {
            boolean matches = ChestWiredUtil.compare(chestManager.getChestContentCount(chest), targetAmount, this.comparison);
    ...
    public boolean saveData(WiredSettings settings) {
        ...
        this.amountVariableSource = ChestWiredUtil.normalizeVariableSource(this.amountVariableType, params.length > 6 ? params[6] : ChestWiredUtil.VARIABLE_TYPE_GLOBAL);
        this.amountVariableName = data.amountVariableName == null ? "" : data.amountVariableName;
