...
public class WiredEffectToggleRandomState extends InteractionWiredEffect {
    private static final Logger LOGGER = LoggerFactory.getLogger(WiredEffectToggleRandomState.class);

    public static final WiredEffectType type = WiredEffectType.TOGGLE_RANDOM_STATE;
    ...
    public WiredEffectToggleRandomState(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredEffectToggleRandomState(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
